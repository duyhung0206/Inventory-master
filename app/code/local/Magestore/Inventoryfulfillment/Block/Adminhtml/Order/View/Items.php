 ...
 */
class Magestore_Inventoryfulfillment_Block_Adminhtml_Order_View_Items
    extends Mage_Adminhtml_Block_Sales_Order_View_Items
{
    ...
    protected function _prepareLayout() {
        ...
        $this->setTemplate('inventoryfulfillment/order/view/items.phtml');
        $this->addItemRender('default', 'inventoryfulfillment/adminhtml_order_view_items_renderer_default', 'inventoryfulfillment/order/view/items/renderer/default.phtml');
    }
